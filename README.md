...
| Database                    | Version                                            |
|-----------------------------|----------------------------------------------------|
| MySQL                       | 5.5.62, 5.6.48, 5.7.30, 8.0.20                     |
| MariaDB                     | 5.5.68, 10.0.38, 10.1.45, 10.2.32, 10.3.23, 10.4.13|
| Percona-Server              | 5.5.62-38.14, 5.6.48-88.0, 5.7.30-33, 8.0.16-7     |

| PHP & Additional extensions | Version                                            |
|-----------------------------|----------------------------------------------------|
| PHP                         | 5.6.40, 7.0.33, 7.1.33, 7.2.32, 7.3.20             |
...
| swoole extension(PHP 7 only)| 4.5.2                                              |
