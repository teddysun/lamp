...
##Software version
#nghttp2
nghttp2_filename="nghttp2-1.49.0"
nghttp2_filename_url="https://github.com/nghttp2/nghttp2/releases/download/v1.49.0/nghttp2-1.49.0.tar.gz"
#openssl
...
#mysql5.7
mysql5_7_filename="mysql-5.7.39"
#mysql8.0
mysql8_0_filename="mysql-8.0.30"
#mariadb10.3
mariadb10_3_filename="mariadb-10.3.36"
#mariadb10.4
mariadb10_4_filename="mariadb-10.4.26"
#mariadb10.5
mariadb10_5_filename="mariadb-10.5.17"
#mariadb10.6
mariadb10_6_filename="mariadb-10.6.9"
#mariadb10.7
mariadb10_7_filename="mariadb-10.7.5"
#php7.4
php7_4_filename="php-7.4.30"
php7_4_filename_url="https://www.php.net/distributions/php-7.4.30.tar.gz"
#php8.0
php8_0_filename="php-8.0.22"
php8_0_filename_url="https://www.php.net/distributions/php-8.0.22.tar.gz"
#php8.1
php8_1_filename="php-8.1.9"
php8_1_filename_url="https://www.php.net/distributions/php-8.1.9.tar.gz"
#phpMyAdmin
