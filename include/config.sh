...
load_config() {
    ...
    #mariadb10.6
    mariadb10_6_filename="mariadb-10.6.20"
    #mariadb10.11
    mariadb10_11_filename="mariadb-10.11.10"
    #php7.4
    ...
    #php8.2
    php8_2_filename="php-8.2.26"
    php8_2_filename_url="https://www.php.net/distributions/php-8.2.26.tar.gz"
    #phpMyAdmin
