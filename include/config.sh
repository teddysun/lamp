...
#mariadb10.1
mariadb10_1_filename="mariadb-10.1.46"
#mariadb10.2
mariadb10_2_filename="mariadb-10.2.33"
#mariadb10.3
mariadb10_3_filename="mariadb-10.3.24"
#mariadb10.4
mariadb10_4_filename="mariadb-10.4.14"
#mariadb10.5
mariadb10_5_filename="mariadb-10.5.5"
#php5.6
...
#php7.3
php7_3_filename="php-7.3.21"
php7_3_filename_url="https://www.php.net/distributions/php-7.3.21.tar.gz"
#php7.4
php7_4_filename="php-7.4.9"
php7_4_filename_url="https://www.php.net/distributions/php-7.4.9.tar.gz"
#phpMyAdmin
...
phpmyadmin_filename2="phpMyAdmin-5.0.2-all-languages"
phpmyadmin_filename2_url="https://files.phpmyadmin.net/phpMyAdmin/5.0.2/phpMyAdmin-5.0.2-all-languages.tar.gz"
#Adminer
...
#re2c
re2c_filename="re2c-2.0.2"
re2c_filename_url="${download_root_url}/re2c-2.0.2.tar.gz"
#cmake
