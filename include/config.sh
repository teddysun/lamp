...
#php7.4
php7_4_filename="php-7.4.16"
php7_4_filename_url="https://www.php.net/distributions/php-7.4.16.tar.gz"
#php8.0
php8_0_filename="php-8.0.3"
php8_0_filename_url="https://www.php.net/distributions/php-8.0.3.tar.gz"
#phpMyAdmin
