...
#php7.2
php7_2_filename="php-7.2.28"
php7_2_filename_url="https://www.php.net/distributions/php-7.2.28.tar.gz"
#php7.3
php7_3_filename="php-7.3.15"
php7_3_filename_url="https://www.php.net/distributions/php-7.3.15.tar.gz"
#phpMyAdmin
