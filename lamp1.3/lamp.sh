...
download_files "mysql-5.6.10.tar.gz" 
...
echo "Installed MySQL version:5.6.10"
echo "Installed PHP version:5.4.13"
echo "Installed phpMyAdmin version:3.5.8"
echo "Enjoy it! ^_^"
echo ""
echo "=========================================================================================="
echo ""
...
echo "============================Start install apache2.4.4====================================="
mv $cur_dir/untar/apr-1.4.6 $cur_dir/untar/httpd-2.4.4/srclib/apr
mv $cur_dir/untar/apr-util-1.5.2 $cur_dir/untar/httpd-2.4.4/srclib/apr-util
cd $cur_dir/untar/httpd-2.4.4
...
echo "============================apache2.4.4 install completed==================================="
else
...
#install MySQL5.6.10
echo "============================Start install MySQL5.6.10====================================="
cd $cur_dir/
/usr/sbin/groupadd mysql
/usr/sbin/useradd -g mysql mysql
cd $cur_dir/untar/mysql-5.6.10
...
exit
EOF
echo "============================MySQL5.6.10 install completed================================="
else
...
echo "============================Start install PHP5.4.13======================================="
#ldap module 
if [ `getconf WORD_BIT` = '32' ] && [ `getconf LONG_BIT` = '64' ] ; then
	cp -frp /usr/lib64/libldap* /usr/lib/
	ln -s /usr/lib64/libc-client.so /usr/lib/libc-client.so
fi
cd $cur_dir/untar/php-5.4.13
...
echo "============================PHP5.4.13 install completed!=================================="
else
...
echo "============================phpMyAdmin3.5.8 install======================================="
cd $cur_dir
mv untar/phpMyAdmin-3.5.8-all-languages /data/www/default/phpmyadmin
...
#Start httpd service
service httpd start
echo "============================phpMyAdmin3.5.8 install completed============================="
}
