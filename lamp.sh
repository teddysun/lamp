...
MariaDBVersion2='mariadb-10.0.20'
PHPVersion='php-5.4.44'
PHPVersion2='php-5.3.29'
PHPVersion3='php-5.5.28'
PHPVersion4='php-5.6.12'
ApacheVersion='httpd-2.4.16'
...
phpMyAdminVersion='phpMyAdmin-4.4.13.1-all-languages'
# Current folder
cur_dir=`pwd`
# CPU Number
