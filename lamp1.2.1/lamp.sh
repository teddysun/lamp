...
download_files "php-5.3.22.tar.gz"
...
download_files "phpMyAdmin-3.5.7-all-languages.tar.gz"
...
echo "Installed PHP version:5.3.22"
echo "Installed phpMyAdmin version:3.5.7"
echo "Enjoy it! ^_^"
echo ""
echo "=========================================================================================="
echo ""
...
echo "============================Start install PHP5.3.22======================================="
#ldap module 
if [ `getconf WORD_BIT` = '32' ] && [ `getconf LONG_BIT` = '64' ] ; then
	cp -frp /usr/lib64/libldap* /usr/lib/
	ln -s /usr/lib64/libc-client.so /usr/lib/libc-client.so
fi
cd $cur_dir/untar/php-5.3.22
...
echo "============================PHP5.3.22 install completed!=================================="
...
echo "============================phpMyAdmin3.5.7 install======================================="
cd $cur_dir
mv untar/phpMyAdmin-3.5.7-all-languages /data/www/default/phpmyadmin
...
#Start httpd service
service httpd start
echo "============================phpMyAdmin3.5.7 install completed============================="
}
