...
#lamplink {position: absolute; top: 20px; left: 115px; text-align: right; font-weight: bold; color: #06C;}
#lamplink a {color: #0000FF; text-decoration: underline;}
...
<div id="page">
    <div id="header">
        <h1>PHP探针</h1>
        <div id="lamplink">for <a href="http://www.bjbsh.com" target="_blank">上海必捷必信息技术有限公司</a></div>
    </div>
...
<div id="footer">
&copy; 2012-2013<br />Based on Yahei Prober.<br />
