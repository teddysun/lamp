###版本`2.2`：`Release date:2013/08/23`
更新记录：

* 1、升级`phpMyAdmin`到版本为`4.0.5`；
* 2、升级`PHP`到版本为`5.4.19`；
* 3、升级`MySQL`到版本`5.6.13`；
* 4、优化升级脚本`update.sh`。`PHP5.5.x`系列`Release`没多久，待测试其兼容性后再做升级，因此修改为升级`PHP`的版本为`5.4.x`系列的最新版。
