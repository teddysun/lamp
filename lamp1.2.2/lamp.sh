...
download_files "php-5.3.24.tar.gz"
...
echo "Installed PHP version:5.3.24"
...
echo "============================Start install PHP5.3.24======================================="
#ldap module 
if [ `getconf WORD_BIT` = '32' ] && [ `getconf LONG_BIT` = '64' ] ; then
	cp -frp /usr/lib64/libldap* /usr/lib/
	ln -s /usr/lib64/libc-client.so /usr/lib/libc-client.so
fi
cd $cur_dir/untar/php-5.3.24
...
echo "============================PHP5.3.24 install completed!=================================="
